...
import com.zamaflow.bpm.api.repository.DocumentRepository;
...
/**
 * REST controller for managing {@link com.zamaflow.bpm.api.domain.Document}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DocumentResource {
    ...
    private static final String ENTITY_NAME = "infringementapiDocument";
