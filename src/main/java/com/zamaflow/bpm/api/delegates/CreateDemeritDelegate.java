...
@Component
public class CreateDemeritDelegate implements JavaDelegate {

    private final Logger LOGGER = LoggerFactory.getLogger(CreateDemeritDelegate.class);
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        infringementService.creatInfringementAction(infringement, delegateExecution.getProcessInstanceId(), delegateExecution.getVariable("adminNotes").toString(), InfringementActionType.INFRINGEMENT_CREATE_DEMERIT, 0.0, 1);
    }
}
